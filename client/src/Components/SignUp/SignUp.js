import { User, Lock, ArrowRightCircle, SquareX, Mail } from "lucide-react";
...
export default function SignUp({changePageStatus, togglePageStatus}) {
    ...
    function handleSubmit(e) {
        ...
        api.post('/auth/signup', {
            ...
            .catch(error => {
                console.log('error has occured in the signup api', error.response.data.message);
            });
    ...
    return (
        <div className="w-full h-full min-h-screen flex justify-center items-center bg-bg absolute top-0 z-10 bg-opacity-80">
            <form
                className="bg-white shadow-lg rounded-2xl p-8 w-80 relative"
            ...
            >
                <div className="relative">
                    ...
                    <SquareX
                        ...
                        onClick={() => changePageStatus('signUpPage', false)}
                    />
                </div>
                ...
                <p className="text-center mt-2">
                    Existing User ?{' '}
                    <span
                        className="text-accent font-bold tracking-wide cursor-pointer"
                        onClick={() =>
                            togglePageStatus('signUpPage', 'loginPage')
                        }
                    >
                        LogIn
                    </span>
